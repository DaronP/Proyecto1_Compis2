...
generate_file = Button(root, command=lambda: file_generation(), text='Generate from File')
generate_file.grid(column=2, row=4)

generate_code = Button(root, command=lambda: code_generation(), text='Generate from Code')
